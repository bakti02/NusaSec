...
cookie `SameSite=Lax`, which is simplest and safest. If you deploy the website on a
genuinely different origin than the API instead, you must configure **both** sides:
